...
@section('card')
    <div class="card rounded-0">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('boardgame.update', $boardgame->id) }}" >
                @csrf
                @method('PATCH')
                <div class="form-row">
                    <div class="col-8">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $boardgame->name) }}" aria-describedby="nameHelp">
                            @error('name')
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('ref_id') is-invalid @enderror" id="ref" name="ref_id" value="{{ old('ref_id', $boardgame->ref_id) }}" aria-describedby="refHelp">
                            @error('ref_id')
                                <span class="text-danger"><i class="fas fa-skull-crossbones"></i> {{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="form-row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('scorecard') is-invalid @enderror" id="scorecard" name="scorecard" rows="20" aria-describedby="scorecardHelp">{{ old('scorecard', $boardgame->scorecard) }}</textarea>
                            @error('scorecard')
                                <span class="text-danger"><i class="fas fa-skull-crossbones"></i> {{ $message }}</span>
                            @enderror
                ...
                <button type="submit" class="btn btn-outline-info rounded-pill">Edit Scorecard</a>
            </form>
        </div>
    </div>
@endsection